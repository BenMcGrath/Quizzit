      ...
      <div class="hero-unit">
            ...
            while($ques_num <= 16)
            {
                ...
                else
                {
                    ...
                    if($Questarray)
                    {
                        ...
                        echo "<td>". "<a href=\"ViewResults.php?qid=".$questionID."\" TARGET=\"_blank\">View Results</a>" ."</td>\n";
                        echo "</tr>";
        ...
        <?php
            ...
            if($ques_num < 15)
            {
                ...
                echo "<a href=\"AddQuestion.php?ques_num=" . $ques_num . "&Quiz_ID=" . $quizinfo['ID'] . "\" TARGET=\"_blank\">Add a question</a>";
            }
        ?>
